...
import static android.os.UserManager.DISALLOW_BLUETOOTH;  // 无效
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            switch (buttonView.getId()) {
                case R.id.switch_auto_time:
                    mDevicePolicyManager.addUserRestriction(DeviceOwnerReceiver.getComponentName(getActivity()), DISALLOW_APPS_CONTROL);
                ...
                case R.id.switch_auto_time_zone:
                    mDevicePolicyManager.clearUserRestriction(DeviceOwnerReceiver.getComponentName(getActivity()), DISALLOW_APPS_CONTROL);
